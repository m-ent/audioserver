...
RSpec.describe "tympanograms/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit tympanogram form" do
    render

    assert_select "form[action=?][method=?]", tympanogram_path(@tympanogram), "post" do
