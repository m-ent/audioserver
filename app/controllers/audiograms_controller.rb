...
class AudiogramsController < ApplicationController
  ...
  def create
    @patient = Patient.find(params[:patient_id])
    @audiogram = @patient.audiograms.create(audiogram_params)
  ...
  def update
    ...
    respond_to do |format|
      if @audiogram.update(audiogram_params)
...
# 以下はまだ使用するかどうか分からない. 重ね書きに関する関数
  ...
  def audiogram_params
    params.fetch(:audiogram, {}).permit(:audiometer, :examdate, :hospital, :comment,\
      :image_location, :manual_input, 
      ...
      :bc_lt_250_scaleout, :bc_lt_500_scaleout, :bc_lt_1k_scaleout, :bc_lt_2k_scaleout,\
      :bc_lt_4k_scaleout,  :bc_lt_8k_scaleout, \
      :bc_rt_250, :bc_rt_500, :bc_rt_1k, :bc_rt_2k, :bc_rt_4k, :bc_rt_8k,\
      :bc_rt_250_scaleout, :bc_rt_500_scaleout, :bc_rt_1k_scaleout, :bc_rt_2k_scaleout,\
      :bc_rt_4k_scaleout, :bc_rt_8k_scaleout, \
